...
const PositionedToast = ({
  ...
  const getStyles = () => {
    switch (type) {
      ...
      default:
        return {
          container: 'bg-neutral-50 dark:bg-gray-700 border-neutral-200 dark:border-gray-600',
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={cn(
            'fixed z-[10000] max-w-sm w-full shadow-lg rounded-xl border backdrop-blur-sm',
            styles.container,
            getPositionClasses(),
            className
          )}
